...
<div id="app" class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>K</b>iosco</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>K</b>iosco</span>
    </a>
    <!-- Header Navbar -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="#">D&I</a>.</strong> Todos los derechos reservados.
  </footer>
...
<script src="adminlte/js/demo.js"></script> AGRANDA MUCHO -->
